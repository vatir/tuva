...
#        print str(results[x]) + "\t" + "0.0" + "\t" + str(t[x]) + "\t" + "omega " + str(omega) + "\t" + "15"
#    group_num += 1
#===============================================================================
filehandle = open("./data/testoutput.dat", 'w')
filehandle.write("dep" + "\t" + "dep_error" + "\t" + "ind" + "\t" + "ind_error" + "\t" + "group" + "\t" + "dna_length" + "\n")
for entry in range(len(flor_values)):
    filehandle.write(str(flor_values[entry]) + "\t" + "0.0" + "\t" + str(t[entry]) + "\t" + "0.0" "\t" + "Given" + "\t" + "15" + "\n")

start_time = time()
#num = len(t)
#exact = laplacedfunc(ones(num)*0.994700358, ones(num)*14.8788504, ones(num)*0.961651086, ones(num)*2.05542668, ones(num)*0.5, ones(num)*32.1455274, t)
exact = laplacedfunc(0.994700358, 14.8788504, 0.961651086, 2.05542668, 0.5, 32.1455274, t)
print "Time elapsed: %f" % (time() - start_time)
print "SSR: %f" % sum((exact - flor_values) ** 2)
#print exact
#print (exact - flor_values)**2
for entry in range(len(flor_values)):
    filehandle.write(str(exact[entry]) + "\t" + "0.0" + "\t" + str(t[entry]) + "\t" + "0.0" + "\t" + "ana" + "\t" + "15" + "\n")
